export const allCards = [
  // Broadcast Projects
  {
    ...
    description:
      'Leading all technical operations for Diamond FM, overseeing studio infrastructure, transmitter management and digital broadcast workflows in Ilorin, Nigeria.',
    image: '/new 1.png',
...
The station now reaches 4 million listeners across the region with a 40% improvement in signal quality since I took on the engineering role.`,
  },
  {
    ...
    category: 'Broadcast',
    tag: 'Project',
    title: 'Radio Netherlands Worldwide Collaboration',
    description:
      'Collaborated with Radio Netherlands Worldwide on content production and signal distribution, bridging international broadcast standards with Nigerian community radio.',
    image: '/new 1 2.png',
    date: '2015',
    readTime: '3 min read',
...
This project helped set the bar for community radio technical excellence in West Africa.`,
  },
  {
    ...
    category: 'Broadcast',
    tag: 'Award',
    title: 'Nigerian Broadcasters Merit Award 2013',
    description:
      'Received the Nigerian Broadcasters Merit Award for outstanding contributions to radio broadcast engineering and community media excellence.',
    image: '/new 6.jpg',
    date: '2013',
    readTime: '2 min read',
...
Stack: Node.js · Express · better-sqlite3 · Socket.IO · JWT Auth · Vanilla JS`,
  ...
  // Social Ventures
  {
    ...
    tag: 'Initiative',
    title: 'Community Radio Empowerment Project',
    description:
      'Driving community radio as a tool for education and civic participation across Kwara State, Nigeria.',
    image: '/h8.jpg',
...
This work was recognised by the ICFJ Knight International Journalism Award in 2018.`,
  },
  {
    ...
    category: 'Social Ventures',
    tag: 'Award',
    title: 'ICFJ Knight Award 2018',
    description:
      'Received the ICFJ Knight International Journalism Award for innovative use of broadcast technology to serve underserved communities.',
    image: '/IMG_4967.PNG',
    date: '2018',
    readTime: '3 min read',
...
This award opened doors to international collaborations and reinforced my commitment to using technology as a force for good.`,
  },
  {
    ...
    category: 'Social Ventures',
    tag: 'Initiative',
    title: 'Digital Literacy Drive in Ilorin',
    description:
      'Running digital literacy workshops for small business owners, women entrepreneurs and secondary school students in Ilorin.',
    image: '/h9.jpg',
...
Over 1,200 people have passed through these workshops with measurable improvements in business outcomes for participants.`,
  ...
  // Articles
  {
    ...
    description:
      'How digital technologies have reshaped radio broadcasting and what it means for engineers on the ground.',
    image: '/analog2digi.png',
    date: 'Jan 2025',
    readTime: '5 min read',
...
The future lies in hybrid approaches combining broadcasting excellence with AI assisted content curation and immersive audio.`,
  },
  {
    ...
    tag: 'Article',
    title: 'Why Nigeria Needs More Broadcast Engineers, Not Fewer',
    description:
      "A case for investing in technical broadcast education as Nigeria's media landscape grows more complex and competitive.",
    image: '/globe.jpg',
    date: 'Mar 2025',
    readTime: '6 min read',
...
Through direct mentorship I have made it my mission to help close this gap.`,
  },
  {
    ...
    tag: 'Article',
    title: "Building Tools for Broadcasters: A Developer's Perspective",
    description:
      'What I learned building internal software tools for a radio station and why broadcast engineering made me a better developer.',
    image: '/h3.jpg',
    date: 'Jun 2025',
    readTime: '5 min read',
...
export const getCardsByPage = (page) => {
  if (page === 'home') return allCards;
  return allCards.filter((c) => c.page === page);
};
