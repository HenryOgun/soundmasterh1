      ...
      <section className="py-6 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-800">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center items-center gap-5 flex-wrap mb-5">
            ...
            <a href="https://youtube.com/@soundmasterh1" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-red-500/30 rounded-full border border-white/20 hover:border-red-400/50 text-white text-sm font-medium transition-all duration-300 hover:scale-105">
